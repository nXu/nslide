...
var NSlide = function () {
    ...
    function NSlide(selector, options) {
        ...
        this.page = 1;
        // Initialize options
        this.options = _lodash2.default.merge(this.defaults, options);
...
var _nslide = __webpack_require__(1);

var _nslide2 = _interopRequireDefault(_nslide);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.slider = new _nslide2.default('#nslide');
